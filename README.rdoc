Link to App on Heroku: https://calm-stream-6264.herokuapp.com/
...
1. Implement Tighter User Control
2. Add a feature in Admin Panel to upload an excel doc of vocabulary via the web app
3. Generate Vocabulary from specific Anime
4. Implement Japanese Language Support
